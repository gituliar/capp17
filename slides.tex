...
\newcommand{\titleboxx}[2]{\centerline{\color{black}\shadowbox{\begin{Bcenter}\Large\color{black} #1\vspace{1mm}\\  {\color{white}q}{\color{black}#2}{\color{white}q}\end{Bcenter}}}}
...
\titleboxx{\Large Example I}{\Large \bf One-Loop Massive Self-Energy}
%{\small
...
\titleboxx{I.1}{\Large Integration-by-Parts Reduction}
\bi
...
\titleboxx{I.1}{\Large Master Integrals}
\begin{Verbatim}[fontsize=\small,frame=lines, label=\fbox{Mathematica}]
...
\titleboxx{I.2}{\Large Differential Equations}
...
$$
\ei
It is very convenient (as observed by J.Henn) to have our system in the epsilon form
$$
...
\titlebox{A few words on \fuchsia}
\fuchsia \ldots
\newpage


\titleboxx{I.3}{\Large Epsilon Form by \fuchsia}
...
\titleboxx{I.5}{\Large Integration Constants \#1}
...
\titleboxx{I.5}{\Large Integration Constants \#2}
  Result \#1
...
\titleboxx{Example I}{\Large \bf Conclusions}
\newpage


\titlebox{II.1 Splitting Functions from $e^+ e^-$-annihilation}
...
We employ a mass-factorization theorem 
$$
...
\titlebox{II.2 Phase-Space Integrals}
...
\titlebox{II.3 Integration-by-Parts}
...
which contains one $x$ factor more in the denominator.

\vs\vs
Maybe $F_1(x) \sim x$? Let us check this\ldots

\newpage


\titlebox{II.4 Differential Equations}
...
\vs\vs
For more details, see the lecture by S.Moch at CAPP17 and  S.Kauers at CAPP11.
\newpage
...
\item In some situation it is much easier to solve ODE than to integrate directly.
\en
\newpage
